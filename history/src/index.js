...
function setupHandlers(app, db, messageChannel) {
    ...
    function consumeViewedMessage(msg) { // Handler for coming messages.
        ...
        // [Sittipat Chandang] Add a video to the history DB along with a corresponding entry name
        return videosCollection.insertOne({videoPath: parsedMsg.videoPath, entry: "video-" + parsedMsg.shortVideoId})
            .then(() => {
